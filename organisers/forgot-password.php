...
if($_SERVER["REQUEST_METHOD"]== "POST" && isset($_POST['email']) && !empty($_POST['email']))
{
    ...
    if($status >=0)
    {
        ...
        sendmail(htmlentities($_POST['email']),'Reset Password : HakVilla.000webhostapp.com','Password Reset Link :
        http://hakvilla.000webhostapp.com/organisers/reset-password.php?email='.$email.'&key='.$key,$headers);
