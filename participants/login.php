...
{
    $x=login('participants',$_POST['email'],$_POST['password']);
    if($x!==true)
    {
        $_SESSION['msg']=$x;
    }
...
$h='<title>Participant\'s Sign In</title>';
...
<div class="container" style="max-width: 500px;">
    ...
    <form method="post" action="">
        ...
        <br>
        <input type="submit" name="submit" value="submit" class="btn btn-success" style="align-self:centre;">
    </form>
    <br>
